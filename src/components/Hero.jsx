    ...
    <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden" id='hero'>
        ...
        <div className='relative z-10 max-w-4xl px-6 text-center'>
            ...
            <div className='flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto'>
                <a href="#projects" className="w-full sm:flex-1">
                    <button className="w-full px-8 py-4 bg-[#8c2bee] text-white font-bold rounded-xl flex items-center justify-center gap-2 hover:shadow-[0_0_20px_rgba(140,43,238,0.4)] transition-all cursor-pointer">
                        View Projects <FaArrowRight />
                    </button>
                </a>

                <a href={Resume} download className="w-full sm:flex-1">
                    <button className='w-full px-8 py-4 bg-[rgba(25,16,34,0.7)] backdrop-blur-md border border-[rgba(140,43,238,0.2)] text-white font-bold rounded-xl flex items-center justify-center gap-2 hover:bg-[#8c2bee]/35 transition-all cursor-pointer'>
