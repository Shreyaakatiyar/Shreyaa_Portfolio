        ...
        <div className='bg-[rgba(25,16,34,0.7)] backdrop-blur-m border border-[rgba(140,43,238,0.2)] p-6 rounded-[40px] overflow-hidden'>
            <div className='grid md:grid-cols-2'>
                <div className='p-12 md:p-16 flex flex-col justify-center gap-8 bg-[#8c2bee]/5'>
                    ...
                    <p className="text-slate-400">Open for collaborations, freelance projects, or just a coffee chat about AI and Design.</p>
                    <div className='space-y-4'>
                        <div className='flex items-center gap-4 group cursor-pointer'>
                            ...
                            <span className="font-medium text-slate-300 group-hover:text-[#8c2bee] transition-colors">shreyaakatiyar@gmail.com</span>
                        </div>
                        ...
                        <div className='flex items-center gap-4 group cursor-pointer'>
                            ...
                            <span className="font-medium text-slate-300 group-hover:text-[#8c2bee] transition-colors">linkedin.com/in/shreyaakatiyar</span>
                        </div>
                        ...
                        <div className='flex items-center gap-4 group cursor-pointer'>
                            ...
                            <span className="font-medium text-slate-300 group-hover:text-[#8c2bee] transition-colors">github.com/Shreyaakatiyar</span>
                        </div>
                    </div>
                </div>
                <div className='p-12 md:p-16'>
                    <form className='space-y-6'>
                        <div className='space-y-2'>
                            ...
                            <input className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-4 focus:border-[#8c2bee] focus:ring-0 transition-all text-white" placeholder="John Doe" type="text"/>
                        </div>
                        <div className='space-y-2'>
                            <label className="text-sm font-bold text-slate-500 uppercase tracking-widest ml-1">Email</label>
                            <input className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-4 focus:border-[#8c2bee] focus:ring-0 transition-all text-white" placeholder="john@example.com" type="email"/>
                        </div>
                        <div className='space-y-2'>
                            <label className="text-sm font-bold text-slate-500 uppercase tracking-widest ml-1">Message</label>
                            <textarea className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-4 focus:border-[#8c2bee] focus:ring-0 transition-all text-white" placeholder="What's on your mind?" rows="4"></textarea>
                        </div>
