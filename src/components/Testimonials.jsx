...
const Testimonials = () => {
  return (
    <section className='py-24 px-6 max-w-6xl mx-auto'>
        <h2 class="text-4xl font-bold mb-16 text-center">Testimonials</h2>
        <div className='grid md:grid-cols-3 gap-8'>
            <div className='bg-[rgba(25,16,34,0.7)] backdrop-blur-md border border-[rgba(140,43,238,0.2)] p-8 rounded-3xl flex flex-col gap-6'>
                ...
                <div className='flex items-center gap-4 mt-auto'>
                    <div class="size-10 rounded-full bg-[#8c2bee]/20"></div>
                    <div>
                        <p class="font-bold text-sm">John Doe</p>
                        <p class="text-xs text-slate-500">HR, XYZ Company</p>
                    </div>
                </div>
            </div>
